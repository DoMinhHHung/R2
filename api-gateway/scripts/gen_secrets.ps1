...
SERVICES_USER=http://localhost:8081
SERVICES_PROPERTY=http://localhost:8082
SERVICES_BOOKING=http://localhost:8083
SERVICES_PAYMENT=http://localhost:8084
SERVICES_NOTIFICATION=http://localhost:8085
